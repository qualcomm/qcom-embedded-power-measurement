#ifndef QEPMCHARTLIVE_H
#define QEPMCHARTLIVE_H
...
class Ui_QEPMChartLiveClass;

class POWERCHART_EXPORT QEPMChartLive :
	public QWidget
{
Q_OBJECT

public:
	QEPMChartLive(QWidget* parent = Q_NULLPTR);
	virtual ~QEPMChartLive();
...
protected:
	...
	Ui_QEPMChartLiveClass*	_ui{Q_NULLPTR};
