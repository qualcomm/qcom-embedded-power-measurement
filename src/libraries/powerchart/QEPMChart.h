...
class Ui_QEPMChartClass;

class POWERCHART_EXPORT QEPMChart :
	public QWidget
{
Q_OBJECT

public:
	QEPMChart(QWidget* parent = Q_NULLPTR);
	virtual ~QEPMChart();
...
protected:
	...
	Ui_QEPMChartClass*		_ui{Q_NULLPTR};
	LineSeriesModel				_lineSeriesModel;
	QwtPlotGrid*				_plotGrid{Q_NULLPTR};
	QEPMCursorLines*			_cursorLines{Q_NULLPTR};
