...
const quint8 SOFTWARE_RESET_RSP					{0x3C};
const quint8 SET_GPIO_DRIVE_CMD					{0x3D};
const quint8 SET_GPIO_DRIVE_RSP					{0x3E};
const quint8 GET_GPIO_DRIVE_CMD					{0x3F};
...
const quint8 GET_16BIT_AVERAGED_BUFFERED_DATA_CMD	{0x53};
const quint8 GET_16BIT_AVERAGED_BUFFERED_DATA_RSP	{0x54};
...
const quint8 SET_MARKER_TRIGGER_CMD				{0x6B};
const quint8 SET_MARKER_TRIGGER_RSP				{0x6C};
const quint8 MARKER_TRIGGER_DISABLE				{0x00};
const quint8 MARKER_TRIGGER_ENABLE_BOTH			{0x03};
const quint8 MARKER_TRIGGER_ACTIVE_HIGH			{0x03};
...
const quint8 GET_CALIBRATION_DATA_CMD_LENGTH			{0x01};
...
const quint8 SET_MARKER_TRIGGER_CMD_LENGTH				{0x03};
const quint8 SET_MARKER_TRIGGER_RSP_LENGTH				{0x02};
