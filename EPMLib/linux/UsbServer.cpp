...
/*
   $Id: //depot/DM/dev/qxdm-qt/QUsb/UsbServer.cpp#28 $
   $Header: //depot/DM/dev/qxdm-qt/QUsb/UsbServer.cpp#28 $
   $Date: 2018/02/09 $
   $DateTime: 2018/02/09 10:24:54 $
   $Change: 1030849 $
   $File: //depot/DM/dev/qxdm-qt/QUsb/UsbServer.cpp $
   $Revision: #28 $
   %Author: msimpson %
   */
