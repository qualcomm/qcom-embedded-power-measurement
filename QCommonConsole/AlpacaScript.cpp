...
#ifdef DEBUG
#ifdef Q_OS_WINDOWS
	if (boardType == ePIC32CXAuto)
		scriptPath = "C:\\github\\AlpacaRepos\\AlpacaConfigs\\tac_configs\\DefaultPIC32CXScript.txt";
	else
		scriptPath = "C:\\github\\AlpacaRepos\\AlpacaConfigs\\tac_configs\\DefaultScript.txt";
#endif
#ifdef Q_OS_LINUX
	if (boardType == ePIC32CXAuto)
		scriptPath = "/local/mnt/workspace/github/AlpacaRepos/AlpacaConfigs/tac_configs/DefaultPIC32CXScript.txt";
	else
		scriptPath = "/local/mnt/workspace/github/AlpacaRepos/AlpacaConfigs/tac_configs/DefaultScript.txt";
#endif
#else
	if (boardType == ePIC32CXAuto)
		scriptPath = tacConfigRoot() + "DefaultPIC32CXScript.txt";
	else
