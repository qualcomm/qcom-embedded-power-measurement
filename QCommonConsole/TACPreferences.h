...
public:
	...
	bool allowConfigUpdates();
	void setAllowConfigUpdates(bool allowConfigUpdates);
	void saveAllowConfigUpdates(bool allowConfigUpdates);
...
private:
	...
	bool						_allowConfigUpdates{false};
};
