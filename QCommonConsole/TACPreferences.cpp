...
const QString kLoadConfigs(QStringLiteral("allowConfigUpdates"));
...
)
{
	...
	_allowConfigUpdates = settings.value(kLoadConfigs, false).toBool();
...
bool TACPreferences::allowConfigUpdates()
{
	return _allowConfigUpdates;
}

void TACPreferences::setAllowConfigUpdates(bool allowConfigUpdates)
{
	_allowConfigUpdates = allowConfigUpdates;
}

void TACPreferences::saveAllowConfigUpdates(bool allowConfigUpdates)
{
	_allowConfigUpdates = allowConfigUpdates;
	...
	settings.beginGroup(kPreferences);
	settings.setValue(kLoadConfigs, allowConfigUpdates);
