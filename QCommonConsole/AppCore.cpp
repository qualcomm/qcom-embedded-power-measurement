...
)
{
	...
	if (loggingState == true)
	{
		...
		writeToAppLog("Alpaca Version: " + QString(ALPACA_VERSION) + "\n");
...
//         rootLevel["product"] = kProductName;
//         rootLevel["app"] = QString(_appName);
//         rootLevel["version"] = kProductVersion;

// #ifdef INTERNAL_BUILD
//         rootLevel["facing"] = QString("Internal");
// #endif

// #ifdef EXTERNAL_BUILD
//         rootLevel["facing"] = QString("External");
// #endif

//         QJsonDocument document = QJsonDocument(rootLevel);
//         QByteArray dataVal = document.toJson(QJsonDocument::Compact);

//         QByteArray startEventID = _appName + "_START";
//         // _telematicsManager->trackEvent(startEventID, dataVal);
//     }
}
...
//		QByteArray startEventID = _appName + "_AUTOMATION_START";
//		_telematicsManager->trackEvent(startEventID, dataVal);
//	}
}
